...
def addRegistroC():
    ...
    try:
        ...
        if cita_id is not None:
            return jsonify({
                'success': True,
                'data': {'id': cita_id, 'id_paciente': id_paciente, 'id_medico': id_medico, 'id_especialidad': id_especialidad, 'fecha_cita': fecha_cita, 'hora':hora, 'id_estado': id_estado, 'motivo_consulta': motivo_consulta,},
                'error': None
            }), 201
        else:
